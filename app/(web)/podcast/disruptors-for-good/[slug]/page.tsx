...
const getData = cache(async ({ params }: Props) => {
  ...
  const url = `/podcast/disruptors-for-good/${episode.slug}`
  ...
  const data = getPageData(url, title, description, {
    breadcrumbs: [
      ...
      { url: "/podcast/disruptors-for-good", title: "Disruptors for Good" },
...
export const generateStaticParams = async () => {
  const episodes = await findPodcastEpisodeSlugs({ where: { show: "dfg" } })
